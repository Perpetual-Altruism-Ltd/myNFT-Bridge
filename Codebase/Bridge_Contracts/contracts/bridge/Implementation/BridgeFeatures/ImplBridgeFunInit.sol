...
/// @title ImplBridgeFunInit
/// @notice The implementation of a bridge initilalisation. Call this function at once before using the bridge.
contract ImplBridgeFunInit  is BridgeMemoryStructure {

    /// @notice Initialize a bridge
    /// @param _localUniverse The local universe this bridge is deployed in. Refer to BridgeMemoryStructure for a list
