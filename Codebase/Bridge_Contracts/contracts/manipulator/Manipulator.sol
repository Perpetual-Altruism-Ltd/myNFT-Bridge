...
contract Manipulator is ManipulatorMemoryStructure, IManipulator{
    constructor() {}
    ...
    */
    ...
    function migrateToERC721IOU(
        ...
        BridgeERC721Departure(_contractAddress).migrateToERC721IOU( _originWorld,  _originTokenId,  _destinationUniverse, _destinationBridge, _destinationWorld, _destinationTokenId, _destinationOwner, _signee);
    ...
    */
    ...
    function migrateFromFullERC721ToERC721(bytes calldata _data, address _contractAddress) external override onlyOwnerOrOperator {
        bytes4 signature = bytes4(keccak256("migrateFromFullERC721ToERC721(bytes32,bytes32,bytes32,bytes32,bytes32,address,uint256,address,address,bytes32,bytes)"));
